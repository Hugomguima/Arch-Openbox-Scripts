...
Config.profilename = "Todas as Faculdades exepto FCUP e PBS"
Config.url = "a página do seu suporte local eduroam®"
Config.email = "helpdesk@uporto.pt"
Config.title = "eduroam CAT"
Config.server_match = "up.pt"
...
Config.user_realm = "*.up.pt"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.up.pt', 'DNS:radius1.up.pt', 'DNS:radius2.up.pt', 'DNS:radius3.up.pt']
